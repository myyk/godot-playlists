...
const ADDON_PATH = "res://addons/dialogue_manager"
...
var next_version_release: Dictionary:
	set(value):
		...
		label.text = Translator.translate(&"update.is_available_for_download") % value.tag_name.substr(1)
	get:
		return next_version_release


func _ready() -> void:
	$VBox/Center/DownloadButton.text = Translator.translate(&"update.download_update")
	$VBox/Center2/NotesButton.text = Translator.translate(&"update.release_notes")
...
func _on_download_button_pressed() -> void:
	...
	download_button.text = Translator.translate(&"update.downloading")
